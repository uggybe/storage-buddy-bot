          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-2">
              <Button
                ...
                className={`flex-1 text-sm px-2 ${sortOrder === "asc" ? "" : "bg-white text-foreground hover:bg-gray-50 border-gray-300"}`}
                onClick={(e) => {
                  e.stopPropagation();
              ...
              <Button
                ...
                className={`flex-1 text-sm px-2 ${sortOrder === "desc" ? "" : "bg-white text-foreground hover:bg-gray-50 border-gray-300"}`}
                onClick={(e) => {
                  e.stopPropagation();
